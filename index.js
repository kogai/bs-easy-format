...
function propagate_forced_breaks(x) {
  var init_acc = function (param) {
    switch (param.tag | 0) {
      case 1 : 
          if (param[0][3][/* wrap_body */7] !== 451368025) {
            return /* false */0;
          } else {
            return /* true */1;
          }
      case 2 : 
          if (param[0][1][/* label_break */0] !== 3884224) {
            return /* false */0;
          } else {
            return /* true */1;
          }
            ...
            if (match$1 !== 451368025) {
              if (match$1 !== 610243080) {
                if (force_breaks) {
                  ...
                  newrecord[/* wrap_body */7] = /* Force_breaks */610243080;
                  return /* tuple */[
                          /* List */Block.__(1, [
                              /* tuple */[
                                match[0],
...
function define_styles(fmt, $$escape, l) {
  if (l !== /* [] */0) {
    Format.pp_set_tags(fmt, /* true */1);
    var tbl1 = Hashtbl.create(/* None */0, (List.length(l) << 1));
    var tbl2 = Hashtbl.create(/* None */0, (List.length(l) << 1));
...
function extra_box(p, l) {
  var match = p[/* wrap_body */7];
  var wrap = match >= 379096626 ? (
      match >= 922275930 ? /* true */1 : /* false */0
...
function open_tag(fmt, param) {
  if (param) {
    return Format.pp_open_tag(fmt, param[0]);
  } else {
    return /* () */0;
  }
}
  ...
  switch (param.tag | 0) {
    ...
    case 1 : 
        ...
        if (p[/* align_closing */6]) {
          fprint_list(fmt, /* None */0, param$1, l);
        } else {
    ...
    case 2 : 
        ...
        if (x.tag === 1) {
          ...
          if (p$1[/* stick_to_label */5] && p$1[/* align_closing */6]) {
            return fprint_list(fmt$1, /* Some */[label], /* tuple */[
                        match[0],
                        match[1],
                        match[2],
                        p$1
...
function to_buffer($staropt$star, $staropt$star$1, buf, x) {
  var $$escape = $staropt$star ? $staropt$star[0] : /* None */870530776;
  var styles = $staropt$star$1 ? $staropt$star$1[0] : /* [] */0;
...
var atom = /* record */[/* atom_style : None */0];

var list = /* record */[
  /* space_after_opening : true */1,
  /* space_after_separator : true */1,
  /* space_before_separator : false */0,
  /* separators_stick_left : true */1,
  /* space_before_closing : true */1,
  /* stick_to_label : true */1,
  /* align_closing : true */1,
  /* wrap_body : Wrap_atoms */-921200851,
  /* indent_body */2,
  /* list_style : None */0,
  /* opening_style : None */0,
  /* body_style : None */0,
  /* separator_style : None */0,
  /* closing_style : None */0
];

var label = /* record */[
  /* label_break : Auto */726666127,
  /* space_after_label : true */1,
...
var Param_000 = /* record */[
  /* space_after_opening : true */1,
  /* space_after_separator : true */1,
  /* space_before_separator : true */1,
  /* separators_stick_left : true */1,
  /* space_before_closing : true */1,
  /* stick_to_label : true */1,
  /* align_closing : true */1,
...
var Param_002 = /* record */[
  /* space_after_opening : false */0,
  /* space_after_separator : false */0,
  /* space_before_separator : false */0,
  /* separators_stick_left : false */0,
  /* space_before_closing : false */0,
  /* stick_to_label : false */0,
  /* align_closing : false */0,
  /* wrap_body : Wrap_atoms */-921200851,
  /* indent_body */2,
  /* list_style : None */0,
  /* opening_style : None */0,
...
var Param_003 = /* record */[
  /* label_break : Auto */726666127,
  /* space_after_label : false */0,
  /* indent_after_label */2,
  /* label_style : None */0
];
